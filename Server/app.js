...
let db;
try{ db=require('./dbserver'); }catch(e){ console.log("DB not connected"); }
...
<div class="hero"><div class="hero-text"><h1>Protecting What Matters <span>Most</span></h1><p><b>Pinnacle Security Limited</b> is Uganda's trusted security company at <b>442/443 Kironde Road, Kampala</b> with branch in Kotido, Karamoja.</p><p>We provide licensed, disciplined and well-trained guards for homes, businesses, construction sites, schools and events. With 4.3★ rating from 11+ clients, we operate 24 hours especially on Friday and have mobile patrol teams.</p><p style="color:#ffcc00;font-weight:600">📞 0754 139726 | ✉️ info@pinnaclegroup.co.ug | ISIC: 8010</p><br><a href="#contact" class="btn-main">Get Guard Now</a> <a href="#join" class="btn-main" style="background:white;margin-left:8px">Join Team</a></div></div>
<div class="section" id="about"><h2>About Pinnacle Security Limited</h2><p style="text-align:center;color:#64748b;max-width:700px;margin:0 auto 20px">Licensed under ISIC 8010 - Private Security Activities. We are committed to professionalism, integrity and quick response.</p><div class="about-grid"><div class="card"><i class="fa-solid fa-shield-halved"></i><h3>Who We Are</h3><p>Pinnacle at Kironde Rd, Kampala serving all regions including Karamoja, Gulu, Pader, Kotido. Trained guards with valid certificates.</p></div><div class="card"><i class="fa-solid fa-bullseye"></i><h3>Our Mission</h3><p>To deliver reliable security through trained manpower, modern tech (CCTV, Alarms, GPS) and 24/7 control room.</p></div><div class="card"><i class="fa-solid fa-clock"></i><h3>Working Hours</h3><p>Mon 8-4, Tue 8:30-4, Wed-Thu 8-4, Fri Open 24 Hours, Sat 10-2:30<br>♿ Wheelchair accessible</p></div></div></div>
<div class="section dark" id="services"><h2>Our Professional Services</h2><p style="text-align:center;color:#94a3b8;max-width:700px;margin:0 auto 20px">We tailor security to your needs - from single guard to full site coverage</p><div class="service-grid"><div class="service-box"><h3 style="color:#ffcc00">🛡️ Security Guard Service</h3><p>Uniformed, vetted licensed guards for residential, commercial, banks, hotels, schools.</p></div><div class="service-box"><h3 style="color:#ffcc00">🏗️ Construction Site Security</h3><p>24hr site security, material checkpoint, theft prevention.</p></div><div class="service-box"><h3 style="color:#ffcc00">📹 CCTV, Alarms & Access</h3><p>HD CCTV, alarms, electric fences, phone viewing.</p></div><div class="service-box"><h3 style="color:#ffcc00">👤 VIP Protection</h3><p>Close protection for VIPs, executives and events.</p></div></div></div>
<div class="section" id="training"><h2>Security Officer Training Gallery</h2><p style="text-align:center;color:#64748b;max-width:700px;margin:0 auto 20px">Our guards undergo 4 weeks intensive training: Parade, Self-defense, First Aid, Fire Safety, Customer Care.</p><div class="gallery"><img src="https://images.unsplash.com/photo-1557597774-9d273605dfa9?w=600"><img src="https://images.unsplash.com/photo-1593113598332-cd288d649433?w=600"><img src="https://images.unsplash.com/photo-1580894906475-0cb46000d6fb?w=600"><img src="https://images.unsplash.com/photo-1560472354-b33ff0c44a43?w=600"><img src="https://images.unsplash.com/photo-1521791136064-7986c2920216?w=600"><img src="https://images.unsplash.com/photo-1604004555489-723a93d6ce74?w=600"></div><p style="text-align:center;margin-top:20px;font-weight:600">We train discipline, respect and integrity - The Pinnacle Way.</p></div>
<div class="section" id="contact"><h2>Contact Us Today</h2><div class="contact-grid"><div><h3>📍 Head Office</h3><p>442/443 Kironde Road<br>Kampala, Uganda<br><br>Branch: Kotido, Karamoja<br><br>📞 0754 139726<br>✉️ info@pinnaclegroup.co.ug<br>⭐ 4.3★ (11 Reviews)</p></div><div id="contactForm" style="background:white;padding:26px;border-radius:18px;box-shadow:0 10px 30px rgba(0,0,0,0.06)"><h3 style="text-align:center">Get Free Quote</h3><input id="n" placeholder="Your Name"><input id="e" placeholder="Phone / Email"><select id="s"><option>Select Service</option><option>Security Guard Service</option><option>Construction Security</option><option>CCTV Installation</option><option>VIP Protection</option></select><textarea id="m" rows="4" placeholder="Message"></textarea><button class="btn-main-dark" onclick="sendMsg()">Send Request →</button><p id="ok" style="display:none;color:green;margin-top:10px;text-align:center;font-weight:700">✅ Sent!</p></div></div></div>
<div class="section" id="join" style="background:#f1f5f9"><h2>Join Pinnacle Security Team</h2><p style="text-align:center;color:#64748b;max-width:700px;margin:0 auto 20px">Recruiting from Kotido, Gulu, Pader, Abim, Moroto, Lira, Kampala. Age 22-45.</p><div class="join-wrapper"><h3 style="text-align:center;margin-bottom:18px">Job Application Form</h3><div class="row"><input id="fname" placeholder="First Name*"><input id="lname" placeholder="Last Name*"></div><div class="row"><select id="gender"><option value="">Gender*</option><option>Male</option><option>Female</option></select><input id="dob" type="date"></div><div class="row"><input id="district" placeholder="District*"><input id="phone" placeholder="Phone*"></div><select id="edu"><option value="">Education Level*</option><option>Primary</option><option>Secondary (S4)</option><option>Advanced (S6)</option><option>Certificate</option><option>Diploma</option><option>Degree</option><option>Masters</option></select><textarea id="exp" rows="4" placeholder="Experience"></textarea><button class="btn-main-dark" onclick="sendJoin()">Submit Application →</button><p id="ok2" style="display:none;color:green;margin-top:10px;text-align:center;font-weight:700">✅ Application Sent!</p></div></div>
<footer><p>© 2026 Pinnacle Security Limited | 442/443 Kironde Rd, Kampala | 0754 139726</p></footer>
<script>
...
// ADMIN PANEL WITH DELETE + CENTERED + ASC
...
app.get('/delete-joiner',checkAdmin,(req,res)=>{
  const id = req.query.id;
  safeQuery("DELETE FROM joiners WHERE id=?",[id],(err)=>{
    if(err) return res.send("Error "+err.message);
