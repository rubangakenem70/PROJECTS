...
<div class="section dark" id="services"><h2>Our Professional Services</h2><p style="text-align:center;color:#94a3b8;max-width:700px;margin:0 auto 20px">We tailor security to your needs - from single guard to full site coverage</p><div class="service-grid"><div class="service-box"><h3 style="color:#ffcc00">🛡️ Security Guard Service</h3><p>Uniformed, vetted licensed guards for residential, commercial, banks, hotels, schools. Access control, patrol, report writing.</p><br><small>✔ Day & Night Shifts | ✔ Supervisor Visits</small></div><div class="service-box"><h3 style="color:#ffcc00">🏗️ Construction Site Security</h3><p>24hr site security, material checkpoint, worker ID verification and theft prevention.</p><br><small>✔ Material Control | ✔ Night Patrol</small></div><div class="service-box"><h3 style="color:#ffcc00">📹 CCTV, Alarms & Access</h3><p>HD CCTV, alarm systems, electric fences, biometric access. View from phone.</p><br><small>✔ HD Night Vision | ✔ Phone Viewing</small></div><div class="service-box"><h3 style="color:#ffcc00">👤 VIP & Event Protection</h3><p>Close protection for VIPs, executives, musicians and private events. Crowd control.</p><br><small>✔ VIP Escort | ✔ Event Security</small></div></div></div>
...
<div class="section" id="contact"><h2>Contact Us Today</h2><div class="contact-grid"><div><h3>📍 Head Office</h3><p>442/443 Kironde Road, Off Ntinda-Kiwatule Road<br>Kampala, Uganda</p><br><p><b>Branch:</b> Kotido District, Karamoja</p><br><p>📞 Phone: 0754 139726<br>✉️ Email: info@pinnaclegroup.co.ug<br>🕒 Control Room: 24 Hours (Friday full)<br><br>⭐ 4.3 (11 Reviews) | ISIC: 8010</p></div><div id="contactForm" style="background:white;padding:26px;border-radius:18px;box-shadow:0 10px 30px rgba(0,0,0,0.06)"><h3 style="text-align:center;margin-bottom:12px">Get Free Quote</h3><input id="n" placeholder="Your Name"><input id="e" placeholder="Phone / Email"><select id="s"><option>Select Service</option><option>Security Guard Service</option><option>Construction Security</option><option>CCTV Installation</option><option>VIP Protection</option></select><textarea id="m" rows="4" placeholder="Tell us about your security need..."></textarea><button class="btn-main-dark" onclick="sendMsg()">Send Request →</button><p id="ok" style="display:none;color:green;margin-top:10px;text-align:center;font-weight:700">✅ Sent! We will call you soon.</p></div></div></div>
<div class="section" id="join" style="background:#f1f5f9"><h2>Join Pinnacle Security Team</h2><p style="text-align:center;color:#64748b;max-width:700px;margin:0 auto 20px">We recruit from Kotido, Gulu, Pader, Abim, Moroto, Lira, Kampala. Age 22-45.</p><div class="join-wrapper"><h3 style="text-align:center;margin-bottom:18px">Job Application Form</h3><div class="row"><input id="fname" placeholder="First Name*"><input id="lname" placeholder="Last Name*"></div><div class="row"><select id="gender"><option value="">Gender*</option><option>Male</option><option>Female</option></select><input id="dob" type="date"></div><div class="row"><input id="district" placeholder="District* e.g. Kotido"><input id="phone" placeholder="Phone*"></div><select id="edu"><option value="">Education Level*</option><option>Primary</option><option>Secondary (S4)</option><option>Advanced (S6)</option><option>Certificate</option><option>Diploma</option><option>Degree</option><option>Masters</option></select><textarea id="exp" rows="4" placeholder="Experience / Why you want to join?"></textarea><button class="btn-main-dark" onclick="sendJoin()">Submit Application →</button><p id="ok2" style="display:none;color:green;margin-top:10px;text-align:center;font-weight:700">✅ Application Sent!</p></div></div>
<footer><p>© 2026 Pinnacle Security Limited | 442/443 Kironde Rd, Kampala | 0754 139726 | info@pinnaclegroup.co.ug</p></footer>
<script>
